...
<table class="wptp-meta-box">
    <tbody>
        ...
        <tr class="has-help">
            <td><?php _e('Agree URL Redirect', $this->plugin_name); ?></td>
            <td>
                <input style="width:100%;" type="text" name="terms_agree_redirecturl" size="45" value="<?php echo esc_attr($meta_terms_agree_redirecturl); ?>"><br>
                <small><?php _e('This URL is the website users will be sent to if they click the Agree button.', $this->plugin_name); ?></small>
            </td>
        </tr>
...
<h3><?php _e('Acknowledgement Check Box', $this->plugin_name); ?></h3>

<table class="wptp-meta-box">
    <tbody>
        <tr>
            <td><?php _e('Enable', $this->plugin_name); ?></td>
            <td><input type="checkbox" name="terms_acknowledgement_on" value="1" <?php checked('1', (isset($meta_terms_acknowledgement_on) ? $meta_terms_acknowledgement_on : 0)); ?>></td>
        </tr>
        
        <tr class="has-help">
            <td><?php _e('Text', $this->plugin_name); ?></td>
            <td>
                <input style="width:100%;" type="text" name="terms_acknowledgement_text" size="45" value="<?php echo esc_attr($meta_terms_acknowledgement_text); ?>"><br>
                <small><?php _e('This is the text that will display next to the acknowledgement check box.', $this->plugin_name); ?></small>
            </td>
        </tr>
    </tbody>
</table>
...
<table class="wptp-meta-box">
    <tbody>
        ...
        <tr>
            <td><?php _e('Date Format', $this->plugin_name); ?></td>
            <td>
        ...
        <tr class="has-help">
            <td><?php _e('Message', $this->plugin_name); ?></td>
            <td>
                <input style="width:100%;" type="text" name="terms_age_message" size="45" value="<?php echo esc_attr($meta_terms_age_message); ?>"><br>
                <small><?php _e('This is the message that will display above the age verification date dropdowns.', $this->plugin_name); ?></small>
            </td>
        </tr>
    </tbody>
</table>